  ...
  return (
    <section id="hero" className={cn("relative w-full h-screen")}>
      <div className="grid md:grid-cols-2">
        <div
          className={cn(
            "h-[calc(100dvh-2rem)] md:h-[calc(100dvh-4rem)] z-[2]",
            "col-span-1",
            "flex flex-col justify-start md:justify-center items-center md:items-start",
            "pt-34 sm:pt-0 sm:pb-25 md:p-24 lg:p-40 xl:p-30"
          )}
        >
          {!isLoading && (
            <>
              ...
              <div className="mt-8 md:ml-2 flex flex-col gap-3">
                <Link
                  href={
                    "https://drive.google.com/file/d/1Nls6YnGNZAlE6aayxsI_2gP9TxCVgEsp/view?usp=sharing"
                  }
                  target="_blank"
                  className="flex-1"
                >
